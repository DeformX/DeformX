...
Run:
  $ISAAC_PYTHON Dataset_generator_datacenter/scripts/gpt.py
...
# CONFIG
# ============================================================
CABLE_ASSET_PATH = str(_DC_DATA / "cables" / "data cernter cable_grey.usdc")
NPZ_PATH = str(_DC_DATA / "npz_file" / "mid.npz")
