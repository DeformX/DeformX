...
Run:
  $ISAAC_PYTHON Dataset_generator_datacenter/scripts/render_datacenter_depth_only.py
...
BACKGROUND_USDS = [
    (
        str(_DC_DATA / "Datacenter_NVD@10012/Assets/DigitalTwin/Assets/Datacenter/Facilities/Stages/Data_Hall/DataHall_Full_01.usd"),
        1.0,
    ),
    (
        str(_DC_DATA / "data_center_scene.usdc"),
        100.0,
    ),
]
...
RENDER_OUTPUT_DIR = str(_DC_DATA / "renders_depth_only")
