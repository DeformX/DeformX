import numpy as np
from pxr import UsdSkel, Gf, Usd, UsdGeom
...
class SkeletonRodDriver:
    ...
    def update_skeleton(self, rod_pos, rod_dir, time_code):
        ...
        # 3. 写入 USD 属性
        self.rot_attr.Set(rotations, time_code)
        self.trans_attr.Set(translations, time_code)
        self.scale_attr.Set(scales, time_code)